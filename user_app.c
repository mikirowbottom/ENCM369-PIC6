...
void UserAppRun(void)
{
    ...
    if(DAC1DATL < 0xFF){
        DAC1DATL = UserApp_au8sinTable[u8Counter++];
        DAC1DATL += 0x04;
        //u8Counter += 4;
    }
    else{
...
//    u8 au8Pattern[9] = { 0x05, 0x14, 0x28, 0x0A, 0x21, 0x0C, 0x05, 0x14, 0x28, 0x0A, 0x21, 0x0C, 0x05, 0x14, 0x28, 0x0A, 0x21, 0x0C,}; //light pattern
